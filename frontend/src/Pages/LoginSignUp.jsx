...
const LoginSignUp = () => {
  return (
    <div className='w-full pt-24 pb-24 bg-fuchsia-100 mb-6'>
      <div className='w-1/3 bg-teal-300 m-auto px-10 py-10'>
        <h1 className='mx-5 text-fuchsia-500 font-semibold text-3xl'>SIGN UP</h1>
        <div className='flex flex-col rounded-2xl gap-7 mt-7'>
          <input className='h-7 text-xl pl-5 text-fuchsia-500 placeholder-fuchsia-500' type="text" placeholder='Your Name' />
          <input className='h-7 text-xl pl-5 text-fuchsia-500 placeholder-fuchsia-500' type="email" placeholder='Email Address' />
          <input className='h-7 text-xl pl-5 text-fuchsia-500 placeholder-fuchsia-500' type="password" placeholder='Password' />  
        </div>   
